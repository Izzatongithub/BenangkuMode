    ...
    <section class="upcoming-workshops">
        <div class="container">
            ...
            <div class="workshops-grid" id="workshopsGrid">
                <!-- Workshop cards will be generated by JavaScript -->
            </div>
        </div>
    </section>
            ...
            <div class="events-grid">
                <div class="event-card">
                    ...
                    <div class="event-content">
                        <h3>Workshop Scarf Merajut</h3>
                        <p class="event-date"><i class="fas fa-calendar"></i> 15 Desember 2023</p>
                        <p class="event-location"><i class="fas fa-map-marker-alt"></i> Studio BenangkuMode, Lombok</p>
                        <p class="event-participants"><i class="fas fa-users"></i> 25 Peserta</p>
                        <p class="event-description">Workshop berhasil dengan antusiasme tinggi dari peserta. Semua peserta berhasil membuat scarf merajut pertama mereka.</p>
                    </div>
                </div>
                <div class="event-card">
                    <div class="event-image">
                    ...
                    <div class="event-content">
                        <h3>Workshop Cardigan Basic</h3>
                        <p class="event-date"><i class="fas fa-calendar"></i> 10 November 2023</p>
                        <p class="event-location"><i class="fas fa-map-marker-alt"></i> Studio BenangkuMode, Lombok</p>
                        <p class="event-participants"><i class="fas fa-users"></i> 20 Peserta</p>
                        <p class="event-description">Workshop cardigan basic yang mengajarkan teknik dasar merajut pakaian. Peserta sangat puas dengan hasilnya.</p>
                    </div>
                </div>
                <div class="event-card">
                    <div class="event-image">
                    ...
                    <div class="event-content">
                        <h3>Workshop Tas Merajut</h3>
                        <p class="event-date"><i class="fas fa-calendar"></i> 5 Oktober 2023</p>
                        <p class="event-location"><i class="fas fa-map-marker-alt"></i> Studio BenangkuMode, Lombok</p>
                        <p class="event-participants"><i class="fas fa-users"></i> 18 Peserta</p>
                        <p class="event-description">Workshop tas merajut yang mengajarkan teknik membuat tas yang kuat dan fashionable.</p>
                    </div>
                </div>
            </div>
        </div>
