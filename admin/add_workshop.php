...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$title || !$category_id || !$instructor || !$start_date || !$duration || !$location || $price === '' || !$max_participants) {
        ...
        $sql = "INSERT INTO workshops (title, description, category_id, instructor, start_date, end_date, duration, location, price, max_participants, image, is_active, is_past_event) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param('ssisssssdisii', $title, $description, $category_id, $instructor, $start_date, $end_date, $duration, $location, $price, $max_participants, $image, $is_active, $is_past_event);
        if ($stmt->execute()) {
            header('Location: workshops.php');
            exit();
        } else {
            $error = 'Gagal menambah workshop.';
        }
    }
}
?>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">Workshops Details</h5>
                            </div>
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="duration" class="form-control" required placeholder="misal: 3 jam">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" name="max_participants" class="form-control" required min="1">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" name="is_past_event" id="is_past_event">
